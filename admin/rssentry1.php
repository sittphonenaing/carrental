...
<head>
	...
	<title>Car Rental Portal | RSS Entry</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">RSS Entry </h2>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Main description</label>
												<div class="col-sm-8">
													<input type="text" class="form-control" name="tamd"  required>
												</div>
											</div>
											<div class="hr-dashed"></div>
