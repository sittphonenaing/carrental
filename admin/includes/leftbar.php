...
<li><a href="#"><i class="fa fa-sitemap"></i> Vehicles</a>
				...
				<li><a href="manage-conactusquery.php"><i class="fa fa-desktop""></i> Manage Contacts us Query</a></li>
			...
			<li><a href="#"><i class="fa fa-table"></i> RSS Feed</a>
					<ul>
						<li><a href="rssentry1.php">RSS Entry</a></li>
						<li><a href="linkentry1.php">Link Entry</a></li>
					</ul>
			</li>
